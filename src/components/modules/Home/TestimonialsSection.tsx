    ...
    <Card className="border-0 shadow-md dark:bg-gray-800">
      <CardContent className="p-6">
        <div className="flex items-center gap-4 mb-4">
          <div className="h-12 w-12 bg-gray-300 dark:bg-gray-600 rounded-full animate-pulse" />
        ...
        <div className="space-y-2">
          ...
          <div className="h-4 w-4/5 bg-gray-200 dark:bg-gray-500 rounded animate-pulse" />
        </div>
      </CardContent>
    </Card>
  );
        ...
        {isLoading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((testimonial) => (
              <Card
                key={testimonial.id}
                className="border-0 shadow-md hover:shadow-lg transition-all duration-300 relative dark:bg-gray-800"
              >
                <CardContent className="p-6">
